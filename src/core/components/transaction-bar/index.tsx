...
export default function TransactionBar({ variant }: Props) {
  ...
  const tabs: Tab[] = [
    { key: 'bets', title: 'Apostas', icon: PokerChipSVG },
...
function PokerChipSVG() {
  return (
    <svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 256 256">
...
function HistorySVG() {
  return (
    <svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 10">
...
function RankingSVG() {
  return (
    <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 18">
